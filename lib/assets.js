...
(function() {
  ...
  ConnectAssets = (function() {
    ...
    ConnectAssets.prototype.createHelpers = function() {
      ...
      context.css = function(route, routeOptions) {
        var attrs;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        try {
          ...
          if (ext === 'css') {
            ...
            startTime = new Date;
            css = cssCompilers[ext].compileSync(this.absPath(sourcePath), source, this.options.helperContext);
  ...
  exports.cssCompilers = cssCompilers = {
    styl: {
      optionsMap: {},
      compileSync: function(sourcePath, source, helperContext) {
    ...
    less: {
      ...
      compileSync: function(sourcePath, source, helperContext) {
        ...
        libs.less.tree.functions.asseturl = function(str) {
          return new libs.less.tree.URL(new libs.less.tree.Anonymous(helperContext.img(str.value)));
        };
